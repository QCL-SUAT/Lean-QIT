...
-- NOTE: `backward.isDefEq.respectTransparency = false` is set library-wide in the
-- lakefile (see the comment there) to restore v4.30 implicit-argument defeq behaviour.
