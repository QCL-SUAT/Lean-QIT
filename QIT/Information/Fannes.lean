...
private theorem mul_correction_div_le (n t : ℝ) (hn : 1 ≤ n) (ht : 0 ≤ t) :
  ...
  · have havglarge : 1 / Real.exp 1 < t / n := lt_of_not_ge havg
    ...
    calc
      n * (1 / Real.exp 1 * (1 / Real.log 2))
          = n * (1 / Real.exp 1) / Real.log 2 := by ring
      _ ≤ (t * Real.log n + 1 / Real.exp 1) / Real.log 2 := hdiv
      _ = t * (Real.log n / Real.log 2) + 1 / Real.exp 1 * (1 / Real.log 2) := by ring
