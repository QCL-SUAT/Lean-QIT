...
private theorem abHatSuccessRestrictedPureVector_ab_marginal
  ...
  intro r _hr
  simpa [t, c, hvtrace, partialTraceA, rankOneMatrix_apply, Finset.mul_sum,
...
private theorem acHatSuccessRestrictedPureVector_ac_marginal
  ...
  apply Finset.sum_congr rfl
  intro r _hr
  simpa [t, k, hvtrace, partialTraceA, rankOneMatrix_apply, Finset.mul_sum,
    Complex.real_smul] using
...
private theorem acHatCanonicalScaledPureAmp_partialTraceA
  ...
  have hACtrace_expanded :
    ...
    simpa [φ, partialTraceB, rankOneMatrix_apply, rankOneMatrix, Matrix.vecMulVec,
      Matrix.trace, Matrix.diag_apply] using hACtrace
