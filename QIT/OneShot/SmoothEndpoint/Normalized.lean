...
theorem conditionalMinEntropyDualEffectChoiMatrix_posSemidef
  ...
  have heq : conditionalMinEntropyDualEffectChoiMatrix (a := a) (b := b) M =
      M.submatrix (fun x : Prod b a => (x.2, x.1)) (fun x : Prod b a => (x.2, x.1)) := rfl
  rw [heq]
...
theorem conditionalMinEntropyDualEffectOfKraus_posSemidef
  ...
  have heq : conditionalMinEntropyDualEffectOfKraus (a := a) (b := b) K =
      (conditionalMinEntropyDualEffectChoiMatrix (a := a) (b := b)
        (conditionalMinEntropyDualEffectOfKraus (a := a) (b := b) K)).submatrix
        (fun x : Prod a b => (x.2, x.1)) (fun x : Prod a b => (x.2, x.1)) := by
    ext x y
    rfl
  rw [heq]
